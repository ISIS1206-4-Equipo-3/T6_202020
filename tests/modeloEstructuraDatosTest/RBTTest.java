...
public class RBTTest {
	...
	public void getHeightTest() {
		...
		assertEquals(3,rbt1.getHeight(1));
		assertEquals(2,rbt1.getHeight(3));
		assertEquals(2,rbt1.getHeight(8));
		assertEquals(4,rbt1.getHeight(9));
		assertEquals(3,rbt1.getHeight(10));
		assertEquals(4,rbt1.getHeight(6));
		assertEquals(4,rbt1.getHeight(2));
		assertEquals(4,rbt1.getHeight(0));
	}
	...
	public void heightTest() {
		setUp1();
		assertEquals(4,rbt1.height());
		setUp3();
		assertEquals(3,rbt2.height());
	}
